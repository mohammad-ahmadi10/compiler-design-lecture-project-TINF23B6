...
public class TInfParser extends Parser {
	...
	public static final int
		...
		TRUE=29, FALSE=30, INT_LIT=31, DOUBLE_LIT=32, STRING_LIT=33, IDENTIFIER=34, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"PRINT", "TYPE_INT", "TYPE_DOUBLE", "TYPE_STRING", "TYPE_BOOL", "TRUE", 
	...
	public final StmtLstContext stmtLst() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 34353353728L) != 0)) {
				{
				{
				setState(67);
				stmt();
